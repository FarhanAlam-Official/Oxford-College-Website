  ...
  const testimonials = [
    {
      ...
      quote: 'The facultys dedication and cutting-edge curriculum have prepared me exceptionally well for my career in tech.',
    ...
    },
    {
      ...
      quote: 'Oxford College provided me with real-world business exposure and networking opportunities that were invaluable.',
    ...
    },
    {
      ...
      quote: 'The research opportunities and mentorship I received here shaped my career in data science.',
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-sm font-medium text-blue-900">{testimonial.company}</p>
            </motion.div>
          ))}
        </div>
      </div>
