  ...
  const programs = [
    {
      ...
      description:
        "Develop leadership skills and business acumen with our comprehensive BBA program.",
      duration: "4 years",
    },
    {
    ...
    },
    {
      ...
      description:
        "Understand global politics, diplomacy, and international affairs.",
      duration: "3 years",
    },
    {
      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose from our diverse range of academic programs designed to
            prepare you for global success
          </p>
        </div>
