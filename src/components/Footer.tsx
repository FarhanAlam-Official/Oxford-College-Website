...
const Footer = () => {
  const links = {
    academics: ['Programs', 'Faculty', 'Research', 'Library', 'Academic Calendar'],
    admissions: ['How to Apply', 'Tuition & Aid', 'Visit Campus', 'International Students'],
    campus: ['Student Life', 'Housing', 'Athletics', 'Events', 'Career Services'],
    about: ['Our Story', 'Leadership', 'News & Media', 'Work with Us', 'Contact']
  };
      ...
      <div className="container py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-white mb-4">OXFORD COLLEGE</h2>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Oxford College Nepal. All rights reserved.
            </p>
